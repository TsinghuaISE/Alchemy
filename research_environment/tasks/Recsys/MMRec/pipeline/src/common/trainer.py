...
class Trainer(AbstractTrainer):
   ...
   and some other features helpful for model training and evaluation.
    ...
    def fit(self, train_data, valid_data=None, test_data=None, saved=False, verbose=True, on_best: Optional[Callable] = None):
            ...
            if (epoch_idx + 1) % self.eval_step == 0:
                ...
                if update_flag:
                    ...
                    if on_best is not None:
                        on_best(self.best_valid_result, self.best_test_upon_valid)
